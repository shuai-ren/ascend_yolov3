...
{
    uint32_t vdecOutWidthStride = AlignSize(srcImage.width, 16); // 128-byte alignment on 310, 64-byte alignment on 710
    uint32_t vdecOutHeightStride = AlignSize(srcImage.height, 2); // 16-byte alignment
